 ...
 */
 // // This may need to change upon experimentation
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Polyformer Commands"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "Script Completed"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Preheat for " PREHEAT_1_LABEL
  #define MAIN_MENU_ITEM_1_GCODE "M104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
  //#define MAIN_MENU_ITEM_1_CONFIRM

  //#define MAIN_MENU_ITEM_2_DESC "Extrude 20m"
  //#define MAIN_MENU_ITEM_2_GCODE "G28\nG29 W"
  //#define MAIN_MENU_ITEM_2_CONFIRM          // Show a confirmation dialog before this action

  //#define MAIN_MENU_ITEM_3_DESC "Extrude 50m"
